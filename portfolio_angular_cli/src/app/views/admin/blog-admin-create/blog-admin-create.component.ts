...
@Component({
  ...
  styleUrls: ['./blog-admin-create.component.css']
})
export class BlogAdminCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authenticationService.authentication("blogAdminCreate")   
  }
  ...
  saveDraft(): void {
    ...
    this.blogService.createData(this.storeData)
